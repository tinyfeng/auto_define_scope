...
Gem::Specification.new do |spec|
  spec.name          = "auto_define_scope"
  spec.version       = AutoDefineScope::VERSION
  spec.authors       = ["tinyfeng.hou"]
  spec.email         = ["tinyfeng.hou@gmail.com"]
  spec.license       = 'MIT'
  ...
  spec.add_dependency "filterrific", ">= 5.1.0"
end
